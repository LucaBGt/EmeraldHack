...
const u32 gTrainerFrontPic_Sheriff[] = INCBIN_U32("graphics/trainers/front_pics/sheriff_front_pic.4bpp.lz");
const u32 gTrainerPalette_Sheriff[] = INCBIN_U32("graphics/trainers/palettes/sheriff.gbapal.lz");
